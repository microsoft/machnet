...
func Recv(ctx *MachnetChannelCtx, base *uint8, len uint) (int, MachnetFlow) {
	var recv_len int
	flow := C.__machnet_recv_go((*C.MachnetChannelCtx_t)(ctx), unsafe.Pointer(base), C.size_t(len), (*C.long)(unsafe.Pointer(&recv_len)))
